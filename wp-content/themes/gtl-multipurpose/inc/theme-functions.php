...
function gtl_multipurpose_dynamic_css(){
	...
	<style>
		...
		body a{ color: <?php echo get_theme_mod('primary_color'); ?>; }

        body a:hover{ color:<?php echo get_theme_mod('primary_color'); ?>; }

        .custom-btn.secondary-btn { background-color: <?php echo get_theme_mod('primary_color'); ?>; }
